...
- Way of separating different python environment for different project
- Say we do have multiple python projects and they are using different version of pyramid or flask then if we upgrade the central python environment, some of the module may not work.
